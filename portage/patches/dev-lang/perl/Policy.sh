...
# bin='/usr/bin'
# scriptdir='/usr/bin'
# privlib='/usr/lib/perl5/5.16.0'
# archlib='/usr/lib/perl5/5.16.0/armv6j-linux'
...
sitelib='/usr/local/lib/perl5/5.16.0'
# sitearch='/usr/local/lib/perl5/5.16.0/armv6j-linux'
...
# vendorlib='/usr/lib/perl5/vendor_perl/5.16.0'
# vendorarch='/usr/lib/perl5/vendor_perl/5.16.0/armv6j-linux'
